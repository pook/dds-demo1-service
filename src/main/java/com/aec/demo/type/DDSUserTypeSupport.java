...
public class DDSUserTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSUser";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DDSUserTypeSupport _singleton
    = new DDSUserTypeSupport();
    ...
    */
    public static DDSUserTypeSupport get_instance() {
        return _singleton;
    }

    public static DDSUserTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DDSUserTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return DDSUser.create();
    }
    ...
    * <code>this</code> is not a <code>DDSUser</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        DDSUser typedDst = (DDSUser) destination;
        DDSUser typedSrc = (DDSUser) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        DDSUser typedSrc = (DDSUser) sample;
        ...
        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.userFname );

        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.userLName );

        currentAlignment  +=  _cdrPrimitiveType.getIntMaxSizeSerialized(epd.getAlignment(currentAlignment));

        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.address );
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSUser typedSrc = (DDSUser) src;

            dst.writeInt(typedSrc.userId);
            dst.writeString(typedSrc.userFname,255);
            dst.writeString(typedSrc.userLName,255);
            dst.writeInt(typedSrc.age);
            dst.writeString(typedSrc.address,255);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                typedDst.userId = src.readInt();
                typedDst.userFname = src.readString(255);
                typedDst.userLName = src.readString(255);
                typedDst.age = src.readInt();
                typedDst.address = src.readString(255);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DDSUser typedDst = (DDSUser) sample;
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            if (!xcdr1 && !inBaseClass_tmp) {
    ...
    */
    ...
    int mask) {
        return new DDSUserDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DDSUserDataReader(native_reader, listener, mask, this);   
    ...
    protected DDSUserTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, DDSUserTypeCode.VALUE, DDSUser.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DDSUserTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, DDSUserTypeCode.VALUE, DDSUser.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
